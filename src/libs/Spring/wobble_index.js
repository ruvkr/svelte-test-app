export class Spring {
  ...
  _config;
  _currentAnimationStep = 0; // current requestAnimationFrame

  _currentTime = 0; // Current timestamp of animation in ms (real time)
  _springTime = 0; // Current time along the spring curve in ms (zero-based)

  _currentValue = 0; // the current value of the spring
  _currentVelocity = 0; // the current velocity of the spring
  _isAnimating = false;
